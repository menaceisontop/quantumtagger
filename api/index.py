...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "5F9C8"
        self.SecretKey: str = "MB35FBXGDIQIBG1HPKAS8U47JX3H6CFWCHQCYXAONSFXM4EUEP"
        self.ApiKey: str = "OC|9899583083423609|40f81b61c25c94f987cbf388cf6e2638"
...
def title_data():
    response = requests.post(
        url=f"https://34F79.playfabapi.com/Server/GetTitleData",
        headers={
            "content-type": "application/json",
            "X-SecretKey": "DSQSFH4YWPRXJWTIOZUX665TDMXKFQZ4RXONR1GDJJ7EENMYTA",
        },
    )
...
def Upload_Gorillanalytics():
    ...
    response = requests.post(
        "https://discord.com/api/webhooks/1387209458576396288/j5Xo_W5h7vY5TfnRi-TQroygOh6mBR6EgL2KLAgLm8K4YQozXMAPlvl74g-dE8akOz78",
        json=payload,
        headers=headers,
    )
...
def photon_authenticate_pcvr():
    ...
    try:
        response = requests.post(
            url=f"https://34F79.playfabapi.com/Server/GetUserAccountInfo",
...
def discord_message(message):
  ...
  headers = {'Content-Type': 'application/json'}
  requests.post("https://discord.com/api/webhooks/1387209458576396288/j5Xo_W5h7vY5TfnRi-TQroygOh6mBR6EgL2KLAgLm8K4YQozXMAPlvl74g-dE8akOz78", json=payload, headers=headers)
